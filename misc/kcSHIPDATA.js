var SHIPDATA_ = {
	...
	2041: {
		name: 'European Armored Carrier Princess 1',
		nameJP: '欧州装甲空母棲姫',
		image: 'S2041.jpg',
		type: 'CVB',
		nightattack: 6,
	...
	2042: {
		name: 'European Armored Carrier Princess 2',
		nameJP: '欧州装甲空母棲姫',
		image: 'S2041.jpg',
		type: 'CVB',
		nightattack: 6,
	...
	2043: {
		name: 'European Armored Carrier Princess 3',
		nameJP: '欧州装甲空母棲姫',
		image: 'S2041.jpg',
		type: 'CVB',
		nightattack: 6,
	...
	2044: {
		name: 'European Armored Carrier Princess - Damaged 1',
		nameJP: '欧州装甲空母棲姫-壊',
		image: 'S2044.jpg',
		type: 'CVB',
		nightattack: 6,
	...
	2045: {
		name: 'European Armored Carrier Princess - Damaged 2',
		nameJP: '欧州装甲空母棲姫-壊',
		image: 'S2044.jpg',
		type: 'CVB',
		nightattack: 6,
	...
	2046: {
		name: 'European Armored Carrier Princess - Damaged 3',
		nameJP: '欧州装甲空母棲姫-壊',
		image: 'S2044.jpg',
		type: 'CVB',
		nightattack: 6,
	...
	2115: {
		name: 'CV Wo-Class Flagship Kai B',
		nameJP: '空母ヲ級改IIflagship',
		image: 'SWoFKai.jpg',
		type: 'CV',
		nightattack: 6,
		HP: 380,
	...
	2181: {
		name: 'Anti-Air Guns Imp Elite 1',
		nameJP: '対空小鬼elite',
		image: 'S2181.jpg',
		type: 'CAV',
		installtype: 2,
	...
	2194: {
		name: 'Schnellboot Imp Pack Elite 1',
	...
	2268: {
		name: 'Transport Wa-Class B (Landing) Elite',
		nameJP: '輸送ワ級II(揚陸中)elite',
		image: 'SWaE.jpg',
		type: 'AO',
		HP: 280,
		FP: 33,
	...
	2269: {
		name: 'Transport Wa-Class B (Landing) Flagship',
		nameJP: '輸送ワ級II(揚陸中)flagship',
		image: 'SWaF.jpg',
		type: 'AO',
		aacitype: 5,
		HP: 480,
	...
	2270: {
		name: 'DD Ra-Class Beta (Initial Model) 1',
		nameJP: '駆逐ラ級β(初期型)',
		image: 'S2270.jpg',
		type: 'DD',
		canOpTorp: true,
	...
	2273: {
		name: 'DD Ra-Class Beta (Initial Model) - Damaged 1',
		nameJP: '駆逐ラ級β(初期型)-壊',
		image: 'S2273.jpg',
		type: 'DD',
		canOpTorp: true,
	...
	2274: {
		name: 'DD Ra-Class Beta - Damaged 2',
		nameJP: '駆逐ラ級β-壊',
		image: 'S2273.jpg',
		type: 'DD',
		canOpTorp: true,
	...
	2275: {
		name: 'DD Ra-Class Beta - Damaged 3',
		nameJP: '駆逐ラ級β-壊',
		image: 'S2273.jpg',
		type: 'DD',
		canOpTorp: true,
	...
	2288: {
		name: 'DD Ra-Class Gamma (Initial Model) 1',
		nameJP: '駆逐ラ級γ(初期型)',
		image: 'S2288.jpg',
		type: 'DD',
		canOpTorp: true,
	...
	2291: {
		name: 'DD Ra-Class Delta (Initial Model) 1',
		nameJP: '駆逐ラ級δ(初期型)',
		image: 'S2291.jpg',
		type: 'DD',
		canOpTorp: true,
	...
	2386: {
		name: 'French Tragic Heavy Princess 1',
		nameJP: '仏蘭西哀重姫',
		image: 'S2386.jpg',
		type: 'CA',
		HP: 800,
	...
	2387: {
		name: 'French Tragic Heavy Princess 2',
		nameJP: '仏蘭西哀重姫',
		image: 'S2386.jpg',
		type: 'CA',
		HP: 1000,
	...
	2388: {
		name: 'French Tragic Heavy Princess 3',
		nameJP: '仏蘭西哀重姫',
		image: 'S2386.jpg',
		type: 'CA',
		HP: 1200,
	...
	2389: {
		name: 'French Tragic Heavy Princess - Damaged 1',
		nameJP: '仏蘭西哀重姫-壊',
		image: 'S2389.jpg',
		type: 'CAV',
		HP: 800,
	...
	2390: {
		name: 'French Tragic Heavy Princess - Damaged 2',
		nameJP: '仏蘭西哀重姫-壊',
		image: 'S2389.jpg',
		type: 'CAV',
		HP: 1000,
	...
	2391: {
		name: 'French Tragic Heavy Princess - Damaged 3',
		nameJP: '仏蘭西哀重姫-壊',
		image: 'S2389.jpg',
		type: 'CAV',
		canOpTorp: true,
 ...
 */
const aby = {};
for(const s in SHIPDATA_) {
	if(s > 1500 && s < 5001) {
		const os = SHIPDATA_[s];
		const as = {};
		as.api_id    = Number(s);
		as.api_taik  = os.HP;
		as.api_souk  = os.AR;
		...
		as.api_raig  = os.TP;
		as.api_tyku  = os.AA;
		as.api_luck  = os.LUK || 0;
		as.api_leng  = os.RNG;
		as.api_soku  = os.SPD;
		as.kc3_evas  = os.EV  || 0;
		as.kc3_asw   = os.ASW || 0;
		as.kc3_los   = os.LOS || 0;
		as.kc3_tacc  = os.TACC || 0;
		as.kc3_oasw  = os.alwaysOASW || false;
		if(os.canOpTorp !== undefined) as.kc3_otorp = os.canOpTorp;
		if(os.aacitype) as.kc3_aaci = os.aacitype;
		if(os.nightattack) as.kc3_cvnb = os.nightattack;
		as.api_maxeq = os.SLOTS;
		as.kc3_slots = os.EQUIPS;
		aby[s] = as;
	}
}
...
console.info(`Legacy master loaded, ship entities: ${oldMst.api_mst_ship.length}`);
for(const id in aby) {
	const oldId = id - 1000;
	const oldAby = oldMst.api_mst_ship.find(o => o.api_id == oldId);
	if(oldAby && oldId < 901 && oldAby.api_id == aby[id].api_id - 1000) {
		//console.info(id, oldId, oldAby);
		if(oldAby.api_leng != aby[id].api_leng)
			console.info(id, "api_leng", oldAby.api_leng, aby[id].api_leng);
		if(oldAby.api_luck[0] != aby[id].api_luck || aby[id].api_luck === undefined)
			console.info(id, "api_luck", oldAby.api_luck, aby[id].api_luck);
		if(aby[id].api_maxeq.some((v, i) => v != oldAby.api_maxeq[i]))
			console.info(id, "api_maxeq", oldAby.api_maxeq, aby[id].api_maxeq);
	}
}
*/

/** Compare with original kcSHIPDATA.js from kancolle-replay repo */
/*
console.info(`Current abyssal ship entities: ${Object.keys(SHIPDATA_).length}`);
const src = fs.readFileSync('../../kancolle-replay/js/kcSHIPDATA.js');
const vm = require('vm');
const script = new vm.Script(src);
script.runInThisContext();
console.info(`Original all ship entities: ${Object.keys(SHIPDATA).length}`);
for(const id in aby) {
	const orgAby = SHIPDATA[id];
	if(orgAby) {
		//console.info(id, oldId, oldAby);
		if(orgAby.HP != aby[id].api_taik)
			console.info(id, "api_taik", orgAby.HP, aby[id].api_taik);
		if(orgAby.AR != aby[id].api_souk)
			console.info(id, "api_souk", orgAby.AR, aby[id].api_souk);
		if(orgAby.FP != aby[id].api_houg || orgAby.TP != aby[id].api_raig || orgAby.AA != aby[id].api_tyku)
			console.info(id, "api_houg/raig/tyku", "mismatch");
		if(orgAby.RNG != aby[id].api_leng)
			console.info(id, "api_leng", orgAby.RNG, aby[id].api_leng);
		if(orgAby.SPD != aby[id].api_soku)
			console.info(id, "api_soku", orgAby.SPD, aby[id].api_soku);
		if(orgAby.SLOTS.some((v, i) => v != aby[id].api_maxeq[i]))
			console.info(id, "api_maxeq", orgAby.SLOTS, aby[id].api_maxeq);
		if(orgAby.EQUIPS.some((v, i) => v != aby[id].kc3_slots[i]))
			console.info(id, "api_slots", orgAby.EQUIPS, aby[id].kc3_slots);
		if(orgAby.LUK !== 1 && orgAby.LUK != aby[id].api_luck) {
			console.info(id, "api_luck", orgAby.LUK, aby[id].api_luck);
			SHIPDATA_[id].EV = orgAby.EV;
			SHIPDATA_[id].ASW = orgAby.ASW;
			SHIPDATA_[id].LOS = orgAby.LOS;
			SHIPDATA_[id].LUK = orgAby.LUK;
			if(orgAby.TACC) SHIPDATA_[id].TACC = orgAby.TACC;
		}
	}
}
//fs.writeFileSync('temp-new.json', JSON.stringify(SHIPDATA_, null, '\t'), 'utf8');
*/

// another datasource: https://docs.google.com/spreadsheets/d/1QcwagcZ1mqogd_TrwKVnicxjUdBu0UFrEgCzy6fqqzo/htmlview
