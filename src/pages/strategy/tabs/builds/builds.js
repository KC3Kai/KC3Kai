(function(){
	...
	KC3StrategyTabs.builds.definition = {
		...
		showList :function(){
			...
			KC3Database.count_build((r => true), total => {
				...
				if(this.totalItems > 0){
					...
					KC3Database.count_build(this.filterFunc, filtered => {
		...
		showPage :function(pageNumber){
			...
			$(".build_list").empty();
			KC3Database.get_build(this.filterFunc, pageNumber, this.itemsPerPage, resultArray => {
