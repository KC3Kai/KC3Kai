		...
		loadMapAssets: function() {
			...
			const getTextureByColorNo = colorNo => {
				switch(colorNo) {
					...
					case 0: return 'map_main_57';
					case 1: return 'map_main_50';
					case 2:
					case 6: return 'map_main_53';
					case 3: return 'map_main_55';
					case 4: return 'map_main_56';
					case 5: return 'map_main_44';
					case 7: return 'map_main_42';
					case 8: return 'map_main_43';
					case 9: return 'map_main_54';
					case 10: return 'map_main_41';
					case 11: return 'map_main_58';
					case 12: return 'map_main_59';
					case 13: return 'map_main_17';
					// -2 indicates boss node red dot before actually entering map
					case -2: return 'map_main_52';
					// -3 indicates extra start point before actually entering map
					case -3: return 'map_main_49';
					case 14: return 'map_main_50';
				}
			};
			this.isLoading = true;
