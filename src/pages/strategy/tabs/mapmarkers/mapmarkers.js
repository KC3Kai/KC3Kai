		...
		loadMapAssets: function() {
			...
			const getTextureByColorNo = colorNo => {
				switch(colorNo) {
					...
					case 1: return 'map_main_48';
					case 2:
					case 6: return 'map_main_51';
					case 3: return 'map_main_53';
					case 4: return 'map_main_54';
					case 5: return 'map_main_42';
					case 7: return 'map_main_40';
					case 8: return 'map_main_41';
					case 9: return 'map_main_52';
					case 10: return 'map_main_39';
