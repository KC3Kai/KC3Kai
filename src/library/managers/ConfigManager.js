		...
		defaults : function(){
			return {
				...
				air_bounds			: {
					"6": [  // fighter
						[0, 0.949], // 0
						[1, 1.549], [3.581, 3.975], [7, 7.324], // 1~3
						[11.345, 11.627], [16.646, 16.898], [16.915, 17.146], [25.162, 25.464] // 4~7
					],
					"7": [  // dive bomber
						[0, 0.949], // 0
						[0, 1.549], [1.581, 1.975], [2, 2.324], // 1~3
						[2.345, 2.627], [2.646, 2.989], [2.915, 3.146], [3.162, 3.464] // 4~7
					],
					"8": [  // torpedo bomber
						[0, 0.949], // 0
						[0, 1.549], [1.581, 1.975], [2, 2.324], // 1~3
					...
					"11": [  // seaplane bomber
						[0, 0.949], // 0
						[0, 1.549], [2.581, 2.975], [3, 3.324], // 1~3
						[3.345, 3.627], [5.646, 5.989], [5.915, 6.146], [9.162, 9.464] // 4~7
					],
					"45": [  // seaplane fighter
						[0, 0.949], // 0
						[1, 1.549], [3.581, 3.975], [7, 7.324], // 1~3
