	...
	window.ConfigManager = {
		...
		defaults : function(){
			return {
				...
				pan_opacity     : 100,
				pan_moon_opacity_preset : "auto",
				pan_moon_opacity: 60,
				pan_box_bcolor  : "rgba(100, 100, 100, 0.618)",
				pan_box_bcolor_moon_preset  : "auto",
				...
				pan_ship_icon_bg_moon_preset: "auto",
				pan_ship_icon_bg_moon: "rgba(0, 42, 134, 0)",
				pan_ship_icon_border: "rgba(34, 65, 105, 1)",
				pan_ship_icon_border_moon_preset: "auto",
				pan_ship_icon_border_moon: "rgba(34, 65, 105, 0)",
				pan_misc_icon_bg: "auto",
				pan_outline_moon_preset: "auto",
				pan_outline_moon: "rgba(0, 130, 130, 0.5)",
				pan_outline_bright_moon: "rgba(0, 190, 190, 0.5)",
				pan_quest_scheme_moon: "auto",
				pan_tooltip_scheme_moon: "auto",
				pan_exped_planner_moon: "auto",
				pan_moon_font_size: "0",
				pan_moon_bg_effect: "auto",
				pan_moon_skin: 0,
				pan_moon_wrapper_bg: "auto",
				pan_moon_element_shape: "auto",
				pan_moon_bar_style: "auto",
				pan_moon_bar_shape: "auto",
