...
(function(exports) {
  ...
  var getExpeditionRequirement = function (v) {
      ...
      if (v === 43) {
          return addGroup(fslAndSc(55)(6))(addGroup(cvecl(1))(addGroup(ddde(3))(addGroup(fsty([ KanColle_Generated_SType.CVL.value, KanColle_Generated_SType.CL.value ]))(addGroup(fpTotal(500))(aswTotal(280))))));
      };
      if (v === 44) {
          return addGroup(fslAndSc(45)(6))(addGroup(carrier(2))(addGroup(sty(1)(KanColle_Generated_SType.AV.value))(addGroup(aswTotal(200))([ new FleetShipWithDrum(3), new FleetDrum(6) ]))));
      };
      if (v === 100) {
