(function () {
    ...
    const baseImgSrc = "https://cdn.discordapp.com/attachments/208597034494722049/373832748210847744/leyte_prep_whatever.png",
        shipPositions = [
            {x: 58, y: 255, id: 131},
            {x: 185, y: 255, id: 143},
            {x: 312, y: 255, id: 80},
...
//waifu for dessert
        ...
        fleetNames = {
            "Kurita Fleet": {x: 673, y: 512, mark: true},
            "Suzuki Fleet": {x: 673, y: 822, mark: true},
            "Nishimura Fleet": {x: 673, y: 1054},
            "Shima Fleet": {x: 1374, y: 502},
            "Ozawa Fleet": {x: 1374, y: 970, mark: true}
        };
