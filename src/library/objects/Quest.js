		...
		switch(type) {
			case 3: // Cxx type, PvP win
				...
				if(context.rankPt >= 4) { // A-Rank+
					...
					if(KC3QuestManager.isPrerequisiteFulfilled(362))
				...
				if(context.rankPt >= 5) { // S-Rank+
					...
					if(KC3QuestManager.isPrerequisiteFulfilled(377))
						KC3QuestManager.get(377).increment(); // Cy16: Yearly Exercises 16
				}
				break;
			...
			case 6: // Fxx type, scrapping slotitem
				switch(context.gearMaster.api_type[2]) {
					...
					case 6: // Fighter
						...
						KC3QuestManager.get(1120).increment(0); // F113 yearly index 0
						break;
					case 7: // Dive Bomber
						KC3QuestManager.get(688).increment(1); // F79 quarterly index 1
						KC3QuestManager.get(681).increment(0); // F95 yearly index 0
						KC3QuestManager.get(1120).increment(1); // F113 yearly index 1
						break;
					case 8: // Torpedo Bomber
						...
						KC3QuestManager.get(1120).increment(2); // F113 yearly index 2
						break;
